...
class GradeCalculator:
    ...
    def assign_letter_grade(self, grade: float) -> str:
        """
    ...
    def calculate_final_grade_with_letter(self) -> Dict[str, Any]:
        """
        ...
        letter_grade = self.assign_letter_grade(final_grade)
    ...
    def generate_detailed_report(self) -> Dict[str, Any]:
        ...
        final_grade_info = self.calculate_final_grade_with_letter()
...
def main():
    ...
    parser = argparse.ArgumentParser(description='Calculate grades from exam data')
    parser.add_argument('--input', '-i', required=True, help='Input JSON file with exam data')
    parser.add_argument('--output', '-o', help='Output JSON file for detailed report')
    parser.add_argument('--total-percentage', '-t', type=float, default=100.0,
                       help='Total percentage to distribute (default: 100.0)')
    ...
    # Load data
    if not calculator.load_data_from_json(args.input):
        print("Failed to load data. Exiting.")
        return
    
    # Calculate percentages if needed
    calculator.calculate_percentages(args.total_percentage)
    ...
    if args.output:
        calculator.save_report_to_json(args.output)
